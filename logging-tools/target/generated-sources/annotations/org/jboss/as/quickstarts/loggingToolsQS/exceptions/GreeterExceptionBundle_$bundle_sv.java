...
public class GreeterExceptionBundle_$bundle_sv
    extends GreeterExceptionBundle_$bundle
    implements GreeterExceptionBundle
{

    public final static GreeterExceptionBundle_$bundle_sv INSTANCE = new GreeterExceptionBundle_$bundle_sv();
